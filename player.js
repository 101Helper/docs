$(".link-lightbox").on("click", function() {
    ...
    var b = '<iframe src="" width="640" height="480" id="video-embed" style="border:0;"></iframe>',
        ...
        g = '<div id="window">',
        h = '<div id="ref"><a href="http://www.the101helper.com">Powered by 101Helper</a>',
        i = "</div></div></div></div>";
    if ($("body").append(g + f + e + d + c + b + h+i), $("#window").hide(), "youtube" == $(this).data("videosite")) var i = "http://www.youtube.com/embed/" + $(this).data("videoid") + "?autoplay=1";
    else if ("vimeo" == $(this).data("videosite")) var i = "http://player.vimeo.com/video/" + $(this).data("videoid") + "?autoplay=1";
